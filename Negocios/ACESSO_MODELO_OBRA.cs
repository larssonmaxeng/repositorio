...
namespace Negocios
{
    ...
    public class ACESSO_MODELO_OBRA : Acesso
    {

        public ACESSO_MODELO_OBRA(string idir) : base(idir)
        {
        ...
        public MODELO_OBRA Sincronizar(MODELO_OBRA parametros, int acao)
        {
            ...
            try
            {
                ...
                while (fb.Read())
                {
                    ...
                    {
                        FuncaoNegocio.CampoPrimaryKey(typeof(MODELO_OBRA)).SetValue(parametros, fb[0].ToString());
